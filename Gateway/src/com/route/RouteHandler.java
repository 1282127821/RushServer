...
//	}
//
//	// TODO:LZGLZG网络消息这块考虑把网关跟客户端
//	// 网关和服务器的进行拆分，GC两个之间不需要有UserIdd带着，只需要通过连接来关联就可以了，
...
//		// int sessionType =
//		// (Integer)session.getAttribute(LinkedClient.SESSION_TYPE);
//		// if (sessionType == SessionType.GAME_CLIENT) {
//		//
//		// } else if (sessionType == SessionType.GAME_SERVER) {
//		//
//		// }
//		// GameLog.error("Session Type : " +
//		// session.getAttribute(LinkedClient.SESSION_TYPE));
