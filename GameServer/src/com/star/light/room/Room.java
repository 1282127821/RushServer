...
import tbgame.pbmessage.GamePBMsg.SyncPVPAIMsg;
import tbgame.pbmessage.GamePBMsg.SyncPVPCommonMsg;
import tbgame.pbmessage.GamePBMsg.SyncPVPMasterChangeMsg;

public class Room extends AbstractActionQueue {
	/**
	 * 房间id
	 */
	public int roomId;
	...
	public void isPVPEnd() {
		...
		if (winCamp != 0) {
			if (winCamp >= BattleCamp.ATTACKER) {  //如果入侵方赢了则把入侵方的玩家添加为防守方的仇敌
