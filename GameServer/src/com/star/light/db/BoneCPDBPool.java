...
public class BoneCPDBPool implements IDBPool {
	...
	public BoneCPDBPool(String dbConnUrl, String dbUserName, String dbPassWord, int maxConn, int fallow) throws Exception {
	...
	/**
	 * 从连接池获得一个可用连接
	 * 如果没有空闲的连接且当前连接数小于最大连接 数限制,则创建新连接
	...
	public int getCurConns() {
		return connectionPool != null ? connectionPool.getTotalCreatedConnections() : 0;	
	}
}