...
public class CmdExecutor {
	...
	public CmdExecutor(int corePoolSize, int maxPoolSize, int keepAliveTime, String prefix) {
		...
		pool = new ThreadPoolExecutor(corePoolSize, maxPoolSize, keepAliveTime, TimeUnit.MINUTES, workQueue, threadFactory, handler);
	...
	public void enDefaultQueue(NetCmd netCmd, PBMessage packet) {
		defaultQueue.enqueue(new CmdTask(null, netCmd, packet, defaultQueue));
	}
