...
CREATE TABLE `tbl_account` (
  `AccountId` bigint(20) NOT NULL DEFAULT '0' COMMENT '账号编号',
  `AccountName` varchar(100) NOT NULL DEFAULT '' COMMENT '账号名',
  `CreateTime` int(11) NOT NULL DEFAULT '0' COMMENT '账号创建时间',
  `LoginTime` int(11) NOT NULL DEFAULT '0' COMMENT '最近登陆时间',
  `LogoutTime` int(11) NOT NULL DEFAULT '0' COMMENT '最后离开时间',
  `LoginIp` varchar(30) NOT NULL DEFAULT '' COMMENT '登陆IP地址',
  `ForbidReason` varchar(50) NOT NULL DEFAULT '' COMMENT '禁号原因',
  `ForbidOperator` varchar(50) NOT NULL DEFAULT '' COMMENT '封号操作人',
  `ForbidExpirtTime` int(11) NOT NULL DEFAULT '0' COMMENT '禁号过期时间',
...
CREATE TABLE `tbl_playerinfo` (
  ...
  `AccountId` bigint(20) NOT NULL DEFAULT '0' COMMENT '账号编号',
  `UserName` varchar(50) NOT NULL DEFAULT '' COMMENT '角色名字',
  `Diamond` int(11) NOT NULL DEFAULT '0' COMMENT '钻石',
  `Gold` int(11) NOT NULL DEFAULT '0' COMMENT '黄金',
  `JobType` smallint(6) NOT NULL COMMENT '玩家职业类型',
  `PlayerState` smallint(6) NOT NULL DEFAULT '0' COMMENT ' 状态',
  `NoviceProcess` int(11) NOT NULL DEFAULT '0' COMMENT '新手引导进度',
  `PlayerLv` int(11) NOT NULL DEFAULT '0' COMMENT '角色等级',
  `VipLv` tinyint(3) NOT NULL DEFAULT '0' COMMENT 'VIP等级',
  `FightStrength` int(11) NOT NULL DEFAULT '0' COMMENT '角色战斗力',
  `PlayerExp` int(11) NOT NULL DEFAULT '0' COMMENT '角色经验',
  `CurrHP` int(11) NOT NULL DEFAULT '0' COMMENT '玩家的当前血量',
  `CurrMP` int(11) NOT NULL DEFAULT '0' COMMENT '玩家的当前法术值',
  `PosX` float NOT NULL DEFAULT '0' COMMENT '玩家所在的X坐标位置',
  `PosY` float NOT NULL DEFAULT '0' COMMENT '玩家所在的Y坐标位置',
  `PosZ` float NOT NULL DEFAULT '0' COMMENT '玩家所在的Z坐标位置',
  `Direct` float NOT NULL DEFAULT '0' COMMENT '玩家的方向',
  `CreateTime` int(11) NOT NULL DEFAULT '0' COMMENT '角色创建时间',
  `LoginTime` int(11) NOT NULL DEFAULT '0' COMMENT '角色登录游戏时间',
  `LogoutTime` int(11) NOT NULL DEFAULT '0' COMMENT '角色登出游戏时间',
  `ResetTime` int(11) NOT NULL DEFAULT '0' COMMENT '角色重置时间',
  `GuildId` bigint(20) NOT NULL DEFAULT '0' COMMENT '公会Id',
  `BlackUser` varchar(3000) NOT NULL DEFAULT '' COMMENT '玩家的黑名单列表',
