...
public final class AccountMgr
{
	...
	public void removeAccount(String accountName)
	{
		...
		//
		// ClientSet.routeCastle(userId, new
		// PBMessage(Protocol.C_S_PLAYER_LOGOUT, userId));
		//
		// // 关闭Socket
	...
	// if (temp != null && temp.getAttribute(LinkedClient.TEMP_SESSION_KEY) !=
	// null) {
	// String beforeToken = (String)
	// temp.getAttribute(LinkedClient.TEMP_SESSION_KEY);
